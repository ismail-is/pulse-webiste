const OfferCard = () => {
  return (
    <div className="offer-card-area">
      <div className="row no-gap row-cols-xxl-4 row-cols-xl-4 row-cols-lg-3 row-cols-sm-2 row-cols-1 justify-content-center">
        <div
          className="col"
          data-aos="fade-up"
        ...
        >
          <div className="offer-card-item style-two">
            ...
            <span className="available-item">7+ Burger menu items</span>
            <div className="bg-text">
 ...
 <div
        ...
        >
          <div className="offer-card-item">
            ...
            <span className="title">Salad </span>
            <span className="available-item">5+ Burger menu items</span>
            <div className="bg-text">
              <span>salad</span> <span>salad</span> <span>salad</span>
            </div>
          </div>
        </div>
        ...
        >
          <div className="offer-card-item style-two">
            ...
            <span className="available-item">2+ Burger menu items</span>
            <div className="bg-text">
